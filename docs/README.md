...
- [OpenClaw 切换 Claude Code SDK 能力差距分析](01-research/openclaw-to-claude-code-sdk-gap-analysis.md)
...
- [ADR-0006：Agent 运行底座迁移到 Claude Code SDK](03-decisions/ADR-0006-claude-code-sdk-agent-runtime-migration.md)
- [ADR-0007：按当前运行环境执行 Runtime 验证](03-decisions/ADR-0007-runtime-deployment-profile-and-docker-gate.md)
- [Agent 角色与协作对抗协议](04-design/agent-roles-and-protocol.md)
- [系统架构、事件模型与运行状态机](04-design/system-architecture.md)
- [Agent Runtime Port 设计与 G2 实现记录](04-design/agent-runtime-port.md)
...
- [Agent Runtime 能力基线与防回退测试计划](05-implementation/agent-runtime-capability-baseline-and-regression-plan.md)
- [OpenClaw Runtime 能力基线报告（2026-09-11）](05-implementation/openclaw-runtime-baseline-2026-09-11.md)
- [Claude Code SDK G3 独立技术探针计划（2026-09-11）](05-implementation/claude-code-sdk-technical-probe-plan-2026-09-11.md)
- [Claude Code SDK G3 技术探针结果（2026-09-11）](05-implementation/claude-code-sdk-technical-probe-result-2026-09-11.md)
- [Claude Agent SDK Adapter G4 实现计划（2026-09-11）](05-implementation/claude-agent-sdk-adapter-g4-plan-2026-09-11.md)
- [Claude Agent SDK Adapter G4 实现结果（2026-09-11）](05-implementation/claude-agent-sdk-adapter-g4-result-2026-09-11.md)
- [OpenClaw 与 Claude Runtime G5 同题能力对照计划（2026-09-11）](05-implementation/openclaw-claude-runtime-g5-comparison-plan-2026-09-11.md)
- [OpenClaw 与 Claude Runtime G5 同题能力对照结果（2026-09-12）](05-implementation/openclaw-claude-runtime-g5-comparison-result-2026-09-12.md)
- [Claude Runtime 完整切换与真实 UI E2E 计划（2026-09-12）](05-implementation/claude-runtime-full-cutover-ui-e2e-plan-2026-09-12.md)
- [Claude Runtime 生产残留扫描（2026-09-12）](05-implementation/claude-runtime-production-residual-scan-2026-09-12.md)
- [Runtime 失败信息公开投影修复（2026-09-12）](05-implementation/runtime-error-public-projection-fix-2026-09-12.md)
- [Agent 审计自适应超时与预算恢复（2026-09-12）](05-implementation/adaptive-agent-timeout-and-budget-recovery-2026-09-12.md)
- [Agent Arena 平台路线图](06-roadmap/platform-roadmap.md)
- [Claude Code SDK Agent Runtime 迁移计划](06-roadmap/claude-code-sdk-migration-plan.md)
...
- [2026-09-11 工作日志](journal/2026-09-11.md)
- [2026-09-12 工作日志](journal/2026-09-12.md)
- [2026-09-13 工作日志](journal/2026-09-13.md)
